    ...
    with split_tabs[2]:
        ...
        if split_method == "Hold-out Method":
            ...
            if st.button("Split Data", key="split_holdout"):
                ...
                if temp_size > 0:
                    ratio_valid_to_test = valid_prop / temp_size
...
with tabs[2]:
    ...
    with aug_tabs[0]:
        ...
        demo_image = Image.open(BytesIO(base64.b64decode("")))
