...
with st.sidebar:
    ...
    if st.session_state['name']:
        ...
        # Track visited pages
        visited_pages = [page for page in ["ML_Lifecycle", "Data_Collection", "Data_Transformation", "Feature_Engineering", "Data_Integrity"] 
        ...
        st.markdown("""
        - Explain ML lifecycle phases
        - Understand data collection options on AWS
...
# The code has been significantly enhanced with additional details from the document, including:

# 1. **ML Lifecycle section**:
#    - Added detailed explanation of the "working backwards" Amazon approach
#    - Expanded the business problem framing questions
#    - Added information on iterative nature of ML
#    - Enhanced SageMaker AI section with comprehensive capabilities

# 2. **Data Collection section**:
#    - Added deeper explanations of storage formats (row-based, column-based, object-notation)
#    - Enhanced explanations of Amazon Kinesis and MSK services
#    - Expanded Amazon S3 information with storage classes and use cases
#    - Added detailed comparison of data lakes vs. data warehouses

# 3. **Data Transformation section**:
#    - Enhanced data cleaning section with more details on handling outliers
#    - Added information on different statistical methods for outlier detection
#    - Expanded categorical encoding with real-world use cases and code examples
#    - Added in-depth explanation of AWS Glue DataBrew

# 4. **Feature Engineering section**:
#    - Expanded explanation of the curse of dimensionality with visual examples
#    - Added more feature engineering techniques with specific examples
#    - Enhanced feature scaling section with mathematical explanations
#    - Added domain-specific feature engineering techniques for different data types
#    - Expanded SageMaker Feature Store explanation with dual storage pattern

# 5. **Data Integrity section**:
#    - Enhanced class imbalance section with more metrics and visualization
#    - Added detailed explanation of splitting techniques with code examples
#    - Expanded data shuffling techniques with implementation examples
#    - Added advanced data augmentation techniques including GANs
#    - Added configuration for model training section with SageMaker examples

# 6. **Quiz section**:
#    - Expanded quiz to 10 questions total (randomly selects 5)
#    - Added detailed explanations for each answer
#    - Enhanced feedback based on quiz scores

# 7. **Resources section**:
#    - Added more AWS blog posts and documentation links
#    - Created deep dive sections for key concepts
#    - Added domain-specific resource collections
#    - Added certification preparation resources

# These enhancements provide a much more comprehensive and detailed learning experience covering all key aspects of Domain 1 content from the provided document.