...
def parameter_sidebar():
    ...
    with st.sidebar:
        ...
        with st.expander("About Guardrails", expanded=True):
            st.markdown("""
            ### Why Use Guardrails?
...
def warn_model_guardrail(model_id, params):
    ...
    # Guardian method
    with st.expander("The Guardrail Solution", expanded=True):
...
def main():
    # Header
    st.markdown("<h1 class='main-header'>LLM Guardrails: Protecting Against Vulnerabilities</h1>", unsafe_allow_html=True)
