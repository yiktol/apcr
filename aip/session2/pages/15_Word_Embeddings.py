# Amazon Bedrock Word Embeddings Explorer - Optimized UI
...
with st.sidebar:
    ...
    st.markdown("""
    This app uses Amazon Bedrock's Titan model to generate text embeddings.
    Word embeddings map words to vectors in a high-dimensional space where
    semantically similar words are positioned closer to each other.
    """)

# Main content area
all_selected_words = selected_words + st.session_state.custom_words
...
with st.form("embedding_form"):
    ...
    if all_selected_words:
        ...
        st.info("Please select words from the sidebar to generate embeddings")
...
st.markdown("""
<div class="footer">
    <p>Word Embeddings Explorer | Powered by Amazon Bedrock Titan Embeddings</p>
</div>
""", unsafe_allow_html=True)
